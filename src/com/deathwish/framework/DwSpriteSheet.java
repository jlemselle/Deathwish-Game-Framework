...
public class DwSpriteSheet extends DwSprite {
	...
	public DwSpriteSheet(Bitmap image, int rows, int columns) {
		super(image);
		Initialise(rows, columns);
	}

	public DwSpriteSheet(Resources resources, int drawable, int rows, int columns) {
